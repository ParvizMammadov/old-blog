        ...
        <div class="container-fluid">
          ...
          <form action="{{ route('articles.update', $article->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="title" id="" required class="form-control" value="{{ $article->title }}">
              </div>
              <div class="form-group">
                  <label for="">Author</label>
                  <input type="text" name="author" id="" required class="form-control" value="{{ $article->author }}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <textarea name="blogcontent" id="" cols="30" rows="10" class="form-control">
                    {!! $article->content !!}
                  </textarea>
                  @error('blogcontent')
                        <div class="alert alert-danger">{{ $message }}</div>
